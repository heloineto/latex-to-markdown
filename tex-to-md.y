...
documentLatex: settings identification main { $$ = newAST(NT_DOCUMENT, $1, $2, $3, NULL); evalAST($$); }
| settings main { $$ = newAST(NT_DOCUMENT, $1, $2, NULL, NULL); evalAST($$); }
;

settings: class package { $$ = newAST(NT_SETTINGS, $1, $2, NULL, NULL); }
...
identification: TITLE CONTENT AUTHOR CONTENT { $$ = newIdentification(NT_IDENTIFICATION, $2, $4); } 
...
| begin bodyList end { $$ = newAST(NT_MAIN, $1, $3, $2, NULL); }
;
...
bodyList: chapter bodyList { $$ = newAST(NT_BODYLIST, $1, $2, NULL, NULL); }
| chapter { $$ = newAST(NT_BODYLIST, $1, NULL, NULL, NULL); }
| section bodyList { $$ = newAST(NT_BODYLIST, $1, $2, NULL, NULL); }
| section { $$ = newAST(NT_BODYLIST, $1, NULL, NULL, NULL); }
| subsection bodyList { $$ = newAST(NT_BODYLIST, $1, $2, NULL, NULL); }
| subsection { $$ = newAST(NT_BODYLIST, $1, NULL, NULL, NULL); }
| body bodyList { $$ = newAST(NT_BODYLIST, $1, $2, NULL, NULL); }
| body { $$ = newAST(NT_BODYLIST, $1, NULL, NULL, NULL); }
;
...
body: text { $$ = newAST(NT_BODY, $1, NULL, NULL, NULL); } 
